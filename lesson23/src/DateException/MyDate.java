...
public class MyDate
{
  ...
  public void setDay(int d)
  {
    ...
    {
      throw new IllegalDateException("Not a day");
    }
    day = d;
  }
  ...
  public void setMonth(int m)
  {
    if (m < 0 || m > 12)
    {
      throw new IllegalDateException("Not a month");
    }
    month = m;
  }
  ...
  public void setYear(int y)
  {
    if (y < 0)
    {
      throw new IllegalDateException("Not a year");
    }
    year = y;
  }
  ...
  //like DateException.MyDate.today
  ...
  //using the Object obj for comparing the objects
  // Object basically takes the all obj classes
  public boolean equals(Object obj)
  {
    ...
    //making a new obj (other) from DateException.MyDate class
